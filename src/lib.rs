// src/lib.rs
/*
 * Core library for ExceptionHandle
 */
...
#[derive(Debug)]
pub struct ExceptionHandleProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ExceptionHandleProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ExceptionHandle processing");
    
    let mut processor = ExceptionHandleProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ExceptionHandleProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ExceptionHandleProcessor::new(false);
